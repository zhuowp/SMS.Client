...
namespace SMS.StreamMedia.ClientSDK
{
    ...
    public class CHCNetSDK
    {
        ...
        **************************************************/
        ...
        //获取当前球机的GIS信息数据
        public const int NET_DVR_GET_GISINFO = 3711;
        ...
        **************************************************/
        ...
        public struct NET_DVR_GIS_INFO
        {
            ...
            public byte byPTZPosExEnable;//是否启用PTZ坐标扩展，0~不启用，PTZ坐标值以struPtzPos 为准。1~启用，PTZ坐标值以struPtzPosEx为准。
            public byte byRes1;
            public NET_DVR_LLI_PARAM struLatitude;     /*纬度*/
            public NET_DVR_LLI_PARAM struLongitude; /*经度*/
            public NET_DVR_PTZPOS_PARAM struPtzPos; //ptz坐标
            ...
            public float fMinHorizontalValue;//最小水平视场角，精确到小数点后面两位；0.0-360.00
            public float fMaxHorizontalValue;//最大水平视场角，精确到小数点后面两位；0.0-360.00
            public float fMinVerticalValue;//最小垂直视场角，精确到小数点后面两位；0.0-360.00
            public float fMaxVerticalValue;//最大垂直视场角，精确到小数点后面两位；0.0-360.00
            [MarshalAsAttribute(UnmanagedType.ByValArray, SizeConst = 220, ArraySubType = UnmanagedType.I1)]
            public byte[] byRes;
        }
        ...
        public struct NET_DVR_STD_CONFIG
        {
            ...
            public uint dwCondSize;            //[in] lpCondBuffer指向的内存大小
            public IntPtr lpInBuffer;            //[in]输入参数(结构体格式),设置时不为NULL，获取时为NULL
            public uint dwInSize;            //[in] lpInBuffer指向的内存大小
            public IntPtr lpOutBuffer;        //[out]输出参数(结构体格式),获取时不为NULL,设置时为NULL
        ...
        **********************************************************/
        [DllImport(@"Dll\HCSDK\HCNetSDK.dll")]
        ...
        **********************************************************/
        ...
        [DllImport(@"Dll\HCSDK\HCNetSDK.dll")]
        public static extern bool NET_DVR_GetSTDConfig(int lUserID, uint dwCommand, ref NET_DVR_STD_CONFIG lpConfigParam);
        ...
        ******************************************************************************/
        ...
        [DllImportAttribute(@"Dll\HCSDK\HCNetSDK.dll")]
